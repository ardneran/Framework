...
Vec1 barycentric(const Vec1& value1, const Vec1& value2, const Vec1& value3, const float& amount1, const float& amount2);
Vec2 barycentric(const Vec2& value1, const Vec2& value2, const Vec2& value3, const float& amount1, const float& amount2);
Vec3 barycentric(const Vec3& value1, const Vec3& value2, const Vec3& value3, const float& amount1, const float& amount2);
Vec4 barycentric(const Vec4& value1, const Vec4& value2, const Vec4& value3, const float& amount1, const float& amount2);

Vec1 catmullRom(const Vec1& value1, const Vec1& value2, const Vec1& value3, const Vec1& value4, const float& amount);
Vec2 catmullRom(const Vec2& value1, const Vec2& value2, const Vec2& value3, const Vec2& value4, const float& amount);
Vec3 catmullRom(const Vec3& value1, const Vec3& value2, const Vec3& value3, const Vec3& value4, const float& amount);
Vec4 catmullRom(const Vec4& value1, const Vec4& value2, const Vec4& value3, const Vec4& value4, const float& amount);

Vec1 hermite(const Vec1& value1, const Vec1& tangent1, const Vec1& value2, const Vec1& tangent2, const float& amount);
Vec2 hermite(const Vec2& value1, const Vec2& tangent1, const Vec2& value2, const Vec2& tangent2, const float& amount);
Vec3 hermite(const Vec3& value1, const Vec3& tangent1, const Vec3& value2, const Vec3& tangent2, const float& amount);
Vec4 hermite(const Vec4& value1, const Vec4& tangent1, const Vec4& value2, const Vec4& tangent2, const float& amount);
